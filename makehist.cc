...
void makehist(string name, Double_t Z, Double_t A){
    int bins = 400;
    int events = 24867292;
    int firstEntry = 0;
//    int events = 1000000;
